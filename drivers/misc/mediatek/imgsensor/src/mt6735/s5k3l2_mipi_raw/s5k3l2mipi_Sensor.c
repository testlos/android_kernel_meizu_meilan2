...
static imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		.pclk = 432000000,				/* record different mode's pclk */
		.linelength = 5504,				/* record different mode's linelength */
		.framelength = 2616, 			/* record different mode's framelength */
	...
	.cap1 = {
		.pclk = 432000000,        /* 266600000 */
		.linelength = 9056,
		.framelength = 3180,      /* 3870 */
		.startx = 0,
		.starty = 0,
...
static SENSOR_WINSIZE_INFO_STRUCT imgsensor_winsize_info[5] = {
	...
	{ 4208, 3120,  184,  480, 3840, 2160, 1280,  720, 0000, 0000, 1280,  720,    0,    0, 1280,  720}, /* hight speed video */
	{ 4192, 3104,    0,    0, 4192, 3104, 2096, 1552, 0000, 0000, 2096, 1552,    0,    0, 2096, 1552}, /* slim video */
#if 0
 ...
 ********************************************************/
	...
	case IMAGE_NORMAL:
		write_cmos_sensor_8(0x0101, 0x03);   /* Gr */
		break;
	case IMAGE_H_MIRROR:
...
*/
	...
	write_cmos_sensor_8(0x0101, 0x03);  /* mirror */
	write_cmos_sensor(0x6028, 0xD000);
	...
	write_cmos_sensor(0x602A, 0x2200);
	...
	write_cmos_sensor(0x6F12, 0x2C20);
	...
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x7C50);
	write_cmos_sensor(0x6F12, 0x9FE5);
	...
	write_cmos_sensor(0x6F12, 0x81E5);
	write_cmos_sensor(0x6F12, 0x1000);
	write_cmos_sensor(0x6F12, 0x85E2);
	write_cmos_sensor(0x6F12, 0x0400);
	write_cmos_sensor(0x6F12, 0xC0E1);
	write_cmos_sensor(0x6F12, 0xB240);
	write_cmos_sensor(0x6F12, 0xC0E1);
	write_cmos_sensor(0x6F12, 0xB040);
	write_cmos_sensor(0x6F12, 0xC0E1);
	write_cmos_sensor(0x6F12, 0xB440);
	write_cmos_sensor(0x6F12, 0xC0E1);
	write_cmos_sensor(0x6F12, 0xB640);
	write_cmos_sensor(0x6F12, 0x9FE5);
	...
	write_cmos_sensor(0x6F12, 0xA540);
	...
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x6018);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x2426);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xA436);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x4827);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0xCC25);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x08C5);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x7024);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0xF004);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0xDC23);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0xCC22);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x7CBC);
	write_cmos_sensor(0x6F12, 0x2DE9);
	write_cmos_sensor(0x6F12, 0x7040);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0xA043);
	write_cmos_sensor(0x6F12, 0xA0E3);
	write_cmos_sensor(0x6F12, 0x0010);
	...
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x9403);
	write_cmos_sensor(0x6F12, 0x80E2);
	write_cmos_sensor(0x6F12, 0x522F);
	write_cmos_sensor(0x6F12, 0x80E2);
	write_cmos_sensor(0x6F12, 0x5010);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x8C03);
	write_cmos_sensor(0x6F12, 0x00EB);
	...
	write_cmos_sensor(0x6F12, 0xD5E1);
	write_cmos_sensor(0x6F12, 0xB2E0);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x7403);
	...
	write_cmos_sensor(0x6F12, 0xB430);
	write_cmos_sensor(0x6F12, 0x52E1);
	...
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xB630);
	write_cmos_sensor(0x6F12, 0x52E1);
	write_cmos_sensor(0x6F12, 0x8301);
	write_cmos_sensor(0x6F12, 0x002A);
	write_cmos_sensor(0x6F12, 0x0500);
	write_cmos_sensor(0x6F12, 0x85E0);
	write_cmos_sensor(0x6F12, 0x80C0);
	write_cmos_sensor(0x6F12, 0xDCE5);
	write_cmos_sensor(0x6F12, 0xA530);
	write_cmos_sensor(0x6F12, 0x53E3);
	...
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xB830);
	write_cmos_sensor(0x6F12, 0x52E1);
	write_cmos_sensor(0x6F12, 0x8301);
	...
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xBA30);
	write_cmos_sensor(0x6F12, 0x52E1);
	write_cmos_sensor(0x6F12, 0x8301);
	...
	write_cmos_sensor(0x6F12, 0x53E3);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xFF0A);
	write_cmos_sensor(0x6F12, 0xEFFF);
	write_cmos_sensor(0x6F12, 0xCCE5);
	write_cmos_sensor(0x6F12, 0xA430);
	write_cmos_sensor(0x6F12, 0x85E0);
	write_cmos_sensor(0x6F12, 0x8030);
	write_cmos_sensor(0x6F12, 0xD3E5);
	write_cmos_sensor(0x6F12, 0xA4C0);
	write_cmos_sensor(0x6F12, 0xC3E5);
	write_cmos_sensor(0x6F12, 0xA5C0);
	write_cmos_sensor(0x6F12, 0x81E0);
	write_cmos_sensor(0x6F12, 0x8C30);
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xBC10);
	write_cmos_sensor(0x6F12, 0xD3E1);
	write_cmos_sensor(0x6F12, 0xBE30);
	write_cmos_sensor(0x6F12, 0x81E2);
	write_cmos_sensor(0x6F12, 0x0D12);
	...
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xBC30);
	write_cmos_sensor(0x6F12, 0x53E3);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xFF1A);
	write_cmos_sensor(0x6F12, 0xD4FF);
	write_cmos_sensor(0x6F12, 0xD4E1);
	write_cmos_sensor(0x6F12, 0xB200);
	write_cmos_sensor(0x6F12, 0xBDE8);
	write_cmos_sensor(0x6F12, 0x7040);
	...
	write_cmos_sensor(0x6F12, 0xBA00);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x9402);
	write_cmos_sensor(0x6F12, 0xD4E1);
	write_cmos_sensor(0x6F12, 0xB420);
	write_cmos_sensor(0x6F12, 0x90E5);
	write_cmos_sensor(0x6F12, 0x0030);
	...
	write_cmos_sensor(0x6F12, 0x80E2);
	write_cmos_sensor(0x6F12, 0x250E);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB0C0);
	write_cmos_sensor(0x6F12, 0x5CE1);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6F12, 0x00CA);
	write_cmos_sensor(0x6F12, 0x1300);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB2C0);
	write_cmos_sensor(0x6F12, 0x5CE1);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6F12, 0x00BA);
	write_cmos_sensor(0x6F12, 0x1000);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xF450);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xF610);
	write_cmos_sensor(0x6F12, 0x41E0);
	write_cmos_sensor(0x6F12, 0x0530);
	write_cmos_sensor(0x6F12, 0xD0E1);
	...
	write_cmos_sensor(0x6F12, 0xD4E1);
	write_cmos_sensor(0x6F12, 0xB610);
	...
	write_cmos_sensor(0x6F12, 0x7040);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x0C52);
	...
	write_cmos_sensor(0x6F12, 0xFC11);
	write_cmos_sensor(0x6F12, 0xD115);
	write_cmos_sensor(0x6F12, 0x0B10);
	write_cmos_sensor(0x6F12, 0x5113);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x000A);
	write_cmos_sensor(0x6F12, 0x3E00);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0xF011);
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xB210);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB222);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0xE841);
	write_cmos_sensor(0x6F12, 0x51E1);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6F12, 0xA023);
	write_cmos_sensor(0x6F12, 0x0010);
	write_cmos_sensor(0x6F12, 0xA033);
	write_cmos_sensor(0x6F12, 0x0110);
	write_cmos_sensor(0x6F12, 0xC4E1);
	write_cmos_sensor(0x6F12, 0xB410);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB402);
	write_cmos_sensor(0x6F12, 0x00EB);
	...
	write_cmos_sensor(0x6F12, 0x020C);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB602);
	write_cmos_sensor(0x6F12, 0x00EB);
	write_cmos_sensor(0x6F12, 0x8400);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0xA811);
	write_cmos_sensor(0x6F12, 0xA0E3);
	write_cmos_sensor(0x6F12, 0x0120);
	write_cmos_sensor(0x6F12, 0xD1E1);
	write_cmos_sensor(0x6F12, 0xB811);
	write_cmos_sensor(0x6F12, 0xA0E3);
	write_cmos_sensor(0x6F12, 0x0030);
	write_cmos_sensor(0x6F12, 0x51E1);
	write_cmos_sensor(0x6F12, 0x0600);
	write_cmos_sensor(0x6F12, 0xC491);
	write_cmos_sensor(0x6F12, 0xB220);
	write_cmos_sensor(0x6F12, 0x009A);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x51E1);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xC481);
	...
	write_cmos_sensor(0x6F12, 0xA0E3);
	write_cmos_sensor(0x6F12, 0x8D0F);
	write_cmos_sensor(0x6F12, 0x90E1);
	write_cmos_sensor(0x6F12, 0xB1E0);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x8001);
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x80C1);
	write_cmos_sensor(0x6F12, 0x5EE3);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xD001);
	write_cmos_sensor(0x6F12, 0xB0E6);
	write_cmos_sensor(0x6F12, 0xD001);
	write_cmos_sensor(0x6F12, 0xB206);
	write_cmos_sensor(0x6F12, 0xD011);
	write_cmos_sensor(0x6F12, 0xB4E5);
	write_cmos_sensor(0x6F12, 0xD011);
	write_cmos_sensor(0x6F12, 0xB605);
	write_cmos_sensor(0x6F12, 0x8EE1);
	write_cmos_sensor(0x6F12, 0x0008);
	write_cmos_sensor(0x6F12, 0x8C05);
	write_cmos_sensor(0x6F12, 0x2C00);
	write_cmos_sensor(0x6F12, 0x8C15);
	write_cmos_sensor(0x6F12, 0x1800);
	write_cmos_sensor(0x6F12, 0x91E5);
	write_cmos_sensor(0x6F12, 0x2CC2);
	write_cmos_sensor(0x6F12, 0x5CE1);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xC4D1);
	write_cmos_sensor(0x6F12, 0xB020);
	write_cmos_sensor(0x6F12, 0x00DA);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6F12, 0x91E5);
	write_cmos_sensor(0x6F12, 0x28C2);
	write_cmos_sensor(0x6F12, 0x5CE1);
	write_cmos_sensor(0x6F12, 0x0000);
	...
	write_cmos_sensor(0x6F12, 0x50E3);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xD411);
	write_cmos_sensor(0x6F12, 0xB200);
	...
	write_cmos_sensor(0x6F12, 0x9011);
	write_cmos_sensor(0x6F12, 0xB100);
	write_cmos_sensor(0x6F12, 0xC411);
	write_cmos_sensor(0x6F12, 0xB600);
	write_cmos_sensor(0x6F12, 0xD4E1);
	write_cmos_sensor(0x6F12, 0xB600);
	write_cmos_sensor(0x6F12, 0x50E3);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x4012);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0xC411);
	write_cmos_sensor(0x6F12, 0xB600);
	write_cmos_sensor(0x6F12, 0x9F15);
	write_cmos_sensor(0x6F12, 0x1401);
	write_cmos_sensor(0x6F12, 0xC011);
	write_cmos_sensor(0x6F12, 0xB030);
	write_cmos_sensor(0x6F12, 0xC011);
	...
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x4480);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xBD88);
	write_cmos_sensor(0x6F12, 0x7040);
	write_cmos_sensor(0x6F12, 0xA081);
	write_cmos_sensor(0x6F12, 0x0018);
	write_cmos_sensor(0x6F12, 0xA081);
	write_cmos_sensor(0x6F12, 0x2118);
	write_cmos_sensor(0x6F12, 0xA083);
	...
	write_cmos_sensor(0x6F12, 0x1040);
	write_cmos_sensor(0x6F12, 0x00EB);
	write_cmos_sensor(0x6F12, 0x4E00);
	write_cmos_sensor(0x6F12, 0x50E3);
	write_cmos_sensor(0x6F12, 0x0000);
	...
	write_cmos_sensor(0x6F12, 0xB020);
	write_cmos_sensor(0x6F12, 0xC1E1);
	write_cmos_sensor(0x6F12, 0xB421);
	write_cmos_sensor(0x6F12, 0xD0E1);
	write_cmos_sensor(0x6F12, 0xB200);
	write_cmos_sensor(0x6F12, 0xC1E1);
	write_cmos_sensor(0x6F12, 0xB801);
	write_cmos_sensor(0x6F12, 0xBDE8);
	write_cmos_sensor(0x6F12, 0x1040);
	write_cmos_sensor(0x6F12, 0x2FE1);
	write_cmos_sensor(0x6F12, 0x1EFF);
	...
	write_cmos_sensor(0x6F12, 0x9FE5);
	write_cmos_sensor(0x6F12, 0x7440);
	write_cmos_sensor(0x6F12, 0xD5E1);
	write_cmos_sensor(0x6F12, 0xB000);
	write_cmos_sensor(0x6F12, 0xA0E3);
	write_cmos_sensor(0x6F12, 0x0010);
	...
	write_cmos_sensor(0x6F12, 0xD4E1);
	write_cmos_sensor(0x6F12, 0xB612);
	write_cmos_sensor(0x6F12, 0xC0E3);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x80E0);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x9FE5);
	...
	write_cmos_sensor(0x6F12, 0x4827);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x9018);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x1018);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x901F);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0070);
	...
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x4C27);
	write_cmos_sensor(0x6F12, 0x00D0);
	write_cmos_sensor(0x6F12, 0x0096);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0x801E);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x3602);
	write_cmos_sensor(0x6F12, 0x00D0);
	write_cmos_sensor(0x6F12, 0x00A6);
	write_cmos_sensor(0x6F12, 0x0070);
	write_cmos_sensor(0x6F12, 0xE018);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x1662);
	write_cmos_sensor(0x6F12, 0x00D0);
	...
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xD0DD);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x44DD);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x68DC);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x7CBC);
	...
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xA0B1);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x7CE4);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x5055);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x9090);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	...
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x5C9D);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	...
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x187F);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	...
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x98C4);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x2C4B);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xDC0C);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xFCE5);
	write_cmos_sensor(0x6F12, 0x1FE5);
	write_cmos_sensor(0x6F12, 0x04F0);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0xA436);
	...
	write_cmos_sensor(0x602A, 0x3692);
	write_cmos_sensor(0x6F12, 0x0060);
	write_cmos_sensor(0x602A, 0x369A);
	write_cmos_sensor(0x6F12, 0xF446);
	write_cmos_sensor(0x6F12, 0x5176);
	write_cmos_sensor(0x6F12, 0x5C76);
	write_cmos_sensor(0x6F12, 0x5C76);
	write_cmos_sensor(0x602A, 0x36AE);
	write_cmos_sensor(0x6F12, 0xF40E);
	write_cmos_sensor(0x6F12, 0x0B00);
	write_cmos_sensor(0x6F12, 0x4B00);
	write_cmos_sensor(0x6F12, 0x4B00);
	write_cmos_sensor(0x602A, 0xF412);
	write_cmos_sensor(0x6F12, 0x0040);
	write_cmos_sensor(0x602A, 0x3664);
	write_cmos_sensor(0x6F12, 0x0BB8);
	write_cmos_sensor(0x602A, 0x35E4);
	write_cmos_sensor(0x6F12, 0x4776);
	write_cmos_sensor(0x602A, 0x3675);
	write_cmos_sensor_8(0x6F12, 0x76);
	write_cmos_sensor(0x602A, 0x3672);
	write_cmos_sensor(0x6F12, 0x0520);
	write_cmos_sensor(0x602A, 0x367A);
	write_cmos_sensor(0x6F12, 0x00ED);
	write_cmos_sensor(0x602A, 0x372A);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x3246);
	write_cmos_sensor(0x6F12, 0x0092);
	write_cmos_sensor(0x602A, 0x324A);
	write_cmos_sensor(0x6F12, 0x009C);
	write_cmos_sensor(0x602A, 0x3256);
	write_cmos_sensor(0x6F12, 0x01BD);
	write_cmos_sensor(0x602A, 0x325A);
	write_cmos_sensor(0x6F12, 0x01C7);
	write_cmos_sensor(0x602A, 0x3248);
	write_cmos_sensor(0x6F12, 0x0092);
	write_cmos_sensor(0x602A, 0x324C);
	write_cmos_sensor(0x6F12, 0x009C);
	write_cmos_sensor(0x602A, 0x3258);
	write_cmos_sensor(0x6F12, 0x01B2);
	write_cmos_sensor(0x602A, 0x325C);
	write_cmos_sensor(0x6F12, 0x01BC);
	write_cmos_sensor(0x602A, 0x3792);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x602A, 0x379A);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x602A, 0x33DA);
	write_cmos_sensor(0x6F12, 0x00BC);
	write_cmos_sensor(0x6F12, 0x00BC);
	write_cmos_sensor(0x6F12, 0x00BE);
	write_cmos_sensor(0x6F12, 0x00BE);
	write_cmos_sensor(0x602A, 0x33EA);
	write_cmos_sensor(0x6F12, 0x00BC);
	write_cmos_sensor(0x6F12, 0x00BC);
	write_cmos_sensor(0x6F12, 0x00D8);
	write_cmos_sensor(0x6F12, 0x00D8);
	write_cmos_sensor(0x602A, 0x36A2);
	write_cmos_sensor(0x6F12, 0x5176);
	write_cmos_sensor(0x6F12, 0x2F76);
	write_cmos_sensor(0x6F12, 0x2F76);
	write_cmos_sensor(0x602A, 0x36B6);
	write_cmos_sensor(0x6F12, 0x0B00);
	write_cmos_sensor(0x6F12, 0x4B00);
	write_cmos_sensor(0x6F12, 0x4B00);
	write_cmos_sensor(0x602A, 0x3690);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x372C);
	write_cmos_sensor_8(0x6F12, 0x48);
	write_cmos_sensor(0x602A, 0x372D);
	write_cmos_sensor_8(0x6F12, 0x48);
	write_cmos_sensor(0x602A, 0x372E);
	write_cmos_sensor(0x6F12, 0x0002);
	write_cmos_sensor(0x6F12, 0x1106);
	write_cmos_sensor(0x6028, 0x7000);
	write_cmos_sensor(0x602A, 0x2754);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x0300);
	write_cmos_sensor(0x602A, 0x2760);
	write_cmos_sensor(0x6F12, 0x080B);
	write_cmos_sensor(0x602A, 0x2758);
	write_cmos_sensor(0x6F12, 0x4500);
	write_cmos_sensor(0x6F12, 0x4700);
	write_cmos_sensor(0x6F12, 0xF800);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x2762);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x2770);
	write_cmos_sensor(0x6F12, 0xE63B);
	write_cmos_sensor(0x602A, 0x2768);
	write_cmos_sensor(0x6F12, 0x4500);
	write_cmos_sensor(0x6F12, 0x4700);
	write_cmos_sensor(0x6F12, 0xF800);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x2772);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x602A, 0x2780);
	write_cmos_sensor(0x6F12, 0xFA3B);
	write_cmos_sensor(0x602A, 0x2778);
	write_cmos_sensor(0x6F12, 0x4500);
	write_cmos_sensor(0x6F12, 0x4700);
	write_cmos_sensor(0x6F12, 0xF800);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x2782);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6028, 0xD000);
	write_cmos_sensor(0x602A, 0x0C00);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor(0x6F12, 0x01FF);
	write_cmos_sensor(0x6F12, 0x0400);
	write_cmos_sensor(0x6F12, 0x0438);
	write_cmos_sensor(0x6F12, 0x0200);
	write_cmos_sensor(0x6F12, 0x03FF);
	write_cmos_sensor(0x6F12, 0x0415);
	write_cmos_sensor(0x6F12, 0x045B);
	write_cmos_sensor(0x6F12, 0x0400);
	write_cmos_sensor(0x6F12, 0x07FF);
	write_cmos_sensor(0x6F12, 0x0421);
	write_cmos_sensor(0x6F12, 0x043B);
	...
	write_cmos_sensor(0x6F12, 0x0426);
	write_cmos_sensor(0x6F12, 0x0426);
	write_cmos_sensor(0x602A, 0x0B80);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x0B86);
	write_cmos_sensor(0x6F12, 0x0020);
	write_cmos_sensor(0x602A, 0x0B84);
	write_cmos_sensor(0x6F12, 0x0020);
	write_cmos_sensor(0x602A, 0x0B82);
	write_cmos_sensor(0x6F12, 0x0003);
	write_cmos_sensor(0x602A, 0x0B8C);
	write_cmos_sensor(0x6F12, 0x000A);
	write_cmos_sensor(0x602A, 0x0B88);
	write_cmos_sensor(0x6F12, 0x0008);
	write_cmos_sensor(0x602A, 0x0B96);
	write_cmos_sensor(0x6F12, 0x0005);
	write_cmos_sensor(0x602A, 0x0B94);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x0602);
	write_cmos_sensor(0x6F12, 0x03FF);
	write_cmos_sensor(0x6F12, 0x03FF);
	write_cmos_sensor(0x6F12, 0x03FF);
	write_cmos_sensor(0x6F12, 0x03FF);
	write_cmos_sensor(0x602A, 0x3BE0);
	write_cmos_sensor(0x6F12, 0x03DA);
	write_cmos_sensor(0x6F12, 0x01D6);
	write_cmos_sensor(0x6F12, 0x01BF);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x6F12, 0x0003);
	write_cmos_sensor(0x6F12, 0x000A);
	...
	write_cmos_sensor(0x6F12, 0xC300);
	write_cmos_sensor(0x6F12, 0xFF00);
	write_cmos_sensor(0x6F12, 0x0032);
	write_cmos_sensor_8(0x6F12, 0x42);
	write_cmos_sensor(0x602A, 0x3DAB);
	write_cmos_sensor_8(0x6F12, 0xFF);
	write_cmos_sensor(0x602A, 0x3DAC);
	write_cmos_sensor_8(0x6F12, 0x08);
	write_cmos_sensor(0x602A, 0x3DAE);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor_8(0x6F12, 0x00);
	write_cmos_sensor(0x602A, 0x3DB1);
	write_cmos_sensor_8(0x6F12, 0x08);
	write_cmos_sensor(0x602A, 0x3DB2);
	write_cmos_sensor(0x6F12, 0x00FF);
	write_cmos_sensor_8(0x6F12, 0x00);
	write_cmos_sensor(0x602A, 0x3DB5);
	write_cmos_sensor_8(0x6F12, 0x08);
	write_cmos_sensor(0x602A, 0x3DB6);
	write_cmos_sensor(0x6F12, 0x0100);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x3DBA);
	write_cmos_sensor(0x6F12, 0x0F00);
	write_cmos_sensor(0x602A, 0x300C);
	write_cmos_sensor(0x6F12, 0x0001);
} /* sensor_init */
...
static void preview_setting(void)
{
	...
	write_cmos_sensor(0x0200, 0x000A);
	write_cmos_sensor(0x0136, 0x1800);
	write_cmos_sensor(0x0304, 0x0006);
	write_cmos_sensor(0x0306, 0x00D8);
	write_cmos_sensor(0x030C, 0x0006);
	write_cmos_sensor(0x030E, 0x00EB);
	write_cmos_sensor(0x0302, 0x0001);
	write_cmos_sensor(0x0300, 0x0002);
	write_cmos_sensor(0x030A, 0x0001);
	write_cmos_sensor(0x0308, 0x0008);
	write_cmos_sensor_8(0x304F, 0x00);
	write_cmos_sensor_8(0x35D9, 0x00);
	write_cmos_sensor(0x303A, 0x02BC);
	write_cmos_sensor_8(0x0B05, 0x01);
	write_cmos_sensor_8(0x0B08, 0x01);
	write_cmos_sensor_8(0x380E, 0x01);
	write_cmos_sensor_8(0x3027, 0x10);
	write_cmos_sensor(0x0202, 0x0014);
	write_cmos_sensor(0x0340, 0x0A38);
	write_cmos_sensor(0x0342, 0x1580);
	...
	write_cmos_sensor(0x0348, 0x106b);
	write_cmos_sensor(0x034A, 0x0C2b);
	write_cmos_sensor(0x3010, 0x0000);
	write_cmos_sensor(0x3012, 0x0000);
	...
	write_cmos_sensor(0x303E, 0x00A0);
	write_cmos_sensor_8(0x30DE, 0x01);
...
static void capture_setting(kal_uint16 currefps)
{
	if (currefps == 150) {
		...
		write_cmos_sensor(0x0306, 0x00D8);
		write_cmos_sensor(0x030C, 0x0006);
		write_cmos_sensor(0x030E, 0x00A8);   /* pclk */
		write_cmos_sensor(0x0302, 0x0001);
		write_cmos_sensor(0x0300, 0x0002);
		write_cmos_sensor(0x030A, 0x0001);
		write_cmos_sensor(0x0308, 0x0008);
		...
		write_cmos_sensor_8(0x3027, 0x10);
		write_cmos_sensor(0x0202, 0x0014);
		write_cmos_sensor(0x0340, 0x0c6c);
		write_cmos_sensor(0x0342, 0x2360);
		...
		write_cmos_sensor(0x0306, 0x00D8);
		write_cmos_sensor(0x030C, 0x0006);
		write_cmos_sensor(0x030E, 0x010E);
		write_cmos_sensor(0x0302, 0x0001);
		write_cmos_sensor(0x0300, 0x0002);
		write_cmos_sensor(0x030A, 0x0001);
		write_cmos_sensor(0x0308, 0x0008);
		...
		write_cmos_sensor(0x0202, 0x0014);
		write_cmos_sensor(0x0340, 0x0c6c);
		write_cmos_sensor(0x0342, 0x11A0);
		write_cmos_sensor(0x034C, 0x1060);
		write_cmos_sensor(0x034E, 0x0C20);
		write_cmos_sensor_8(0x0114, 0x03);
		write_cmos_sensor(0x0344, 0x000C);
...
static void hs_video_setting(void)
{
	...
	write_cmos_sensor(0x6F12, 0x0006);
	write_cmos_sensor(0x6F12, 0x00C6);
	...
	write_cmos_sensor(0x6F12, 0x0008);
	write_cmos_sensor(0x602A, 0x3002);
	write_cmos_sensor_8(0x6F12, 0x00);

	write_cmos_sensor(0x602A, 0x35D9);
	write_cmos_sensor_8(0x6F12, 0x03);    /* 00 */
	write_cmos_sensor(0x602A, 0x303A);
	write_cmos_sensor(0x6F12, 0x017C);    /* 02BC */
	write_cmos_sensor(0x602A, 0x0B05);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x0B08);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x380E);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x3027);
	write_cmos_sensor_8(0x6F12, 0x30);

	write_cmos_sensor(0x602A, 0x0342);
	write_cmos_sensor(0x6F12, 0x1190);    /* 11A0 */
	write_cmos_sensor(0x602A, 0x0340);
	write_cmos_sensor(0x6F12, 0x0339);
	write_cmos_sensor(0x602A, 0x034C);
	write_cmos_sensor(0x6F12, 0x0500);
	...
	write_cmos_sensor(0x6F12, 0x0FB9);
	write_cmos_sensor(0x6F12, 0x0A4E);
	write_cmos_sensor(0x602A, 0x0386);
	write_cmos_sensor(0x6F12, 0x0005);
	write_cmos_sensor(0x602A, 0x0382);
	write_cmos_sensor(0x6F12, 0x0001);
	write_cmos_sensor(0x602A, 0x0900);
	write_cmos_sensor_8(0x6F12, 0x01);
	write_cmos_sensor(0x602A, 0x0901);
	write_cmos_sensor_8(0x6F12, 0x13);
	...
	write_cmos_sensor(0x602A, 0x0112);
	write_cmos_sensor(0x6F12, 0x0A0A);
	write_cmos_sensor(0x602A, 0x302A);
	write_cmos_sensor_8(0x6F12, 0x00);
	write_cmos_sensor(0x602A, 0x0500);
	write_cmos_sensor(0x6F12, 0x0000);
	write_cmos_sensor(0x602A, 0x303E);
	write_cmos_sensor(0x6F12, 0x00A0);
	write_cmos_sensor(0x602A, 0x30DE);
	write_cmos_sensor_8(0x6F12, 0x01);
...
static kal_uint32 set_test_pattern_mode(kal_bool enable)
{
	...
	if (enable) {
		write_cmos_sensor(0x6028, 0xD000);
		write_cmos_sensor(0x602A, 0x0600);
		write_cmos_sensor(0x6F12, 0x0002);
...
//#endif
			...
			LOG_INF("s5k3l2 Read sensor id fail, write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id, *sensor_id);
			retry--;
		} while (retry > 0);
		i++;
		retry = 1;
