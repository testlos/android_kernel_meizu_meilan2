...
// Define the power enable GPIO manually as cust_gpio_usage.h is not generated by DrvGen
#define GPIO_LCM_PWR_EN               (GPIO119 | 0x80000000)
#define GPIO_LCM_PWR_EN_M_GPIO        GPIO_MODE_00
#define GPIO_LCM_PWR_EN_M_BPI_BUS     GPIO_MODE_01
#define GPIO_LCM_PWR_EN_M_DBG_MON_B   GPIO_MODE_07
#endif
...
static unsigned char  lcd_type_id= 0; //wenggaojian@wind-mobi.com 20150702
// ---------------------------------------------------------------------------
//  Local Constants
// ---------------------------------------------------------------------------
...
static unsigned int lcm_compare_id(void)
{
	...
	lcd_type_id = buffer[0]; //wenggaojian@wind-mobi.com 20150702
#ifdef BUILD_LK
	printf("%s,  id otm1285A= 0x%08x\n", __func__, id);
#else
	pr_info("%s,  id otm1285A= 0x%08x\n", __func__, id);
#endif
